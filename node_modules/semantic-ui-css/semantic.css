...
.ui.basic.grey.button {
  box-shadow: 0px 0px 0px 1px #414344 inset !important;
...
.ui.loading.loading.input > i.icon:after {
  ...
  animation-iteration-count: infinite;
  border-radius: 500rem;
  border-color: #414344 transparent transparent;
  border-style: solid;
  border-width: 0.2em;
  box-shadow: 0px 0px 0px 1px transparent;
}
...
.ui.loading.segment:after {
  ...
  animation-iteration-count: infinite;
  border-radius: 500rem;
  border-color: #414344 rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.1);
  border-style: solid;
  border-width: 0.2em;
  box-shadow: 0px 0px 0px 1px transparent;
  visibility: visible;
...
.ui.cards > .grey.card,
.ui.grey.card {
  box-shadow: 0px 0px 0px 1px #D4D4D5, 0px 2px 0px 0px #414344, 0px 1px 3px 0px #D4D4D5;
}
